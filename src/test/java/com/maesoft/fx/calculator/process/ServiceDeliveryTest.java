...
public class ServiceDeliveryTest {
    ...
    @Test
    public void serviceDeliveryTestValidExpressionTest() throws CalculatorException {
        System.out.println("Test1");

        assertEquals(422.5,serviceDelivery.calculate("65*6.5"),0.0);
        ...
        assertEquals(-19.0,serviceDelivery.calculate("-(10 - 9) * 9 - (2 + 8)"),0.0);
        assertEquals(-13.0,serviceDelivery.calculate("-16+3"),0.0);
        assertEquals(-19.0,serviceDelivery.calculate("-(16+3)"),0.0);
        assertEquals(-18.0,serviceDelivery.calculate("7+10-(7+7*4)"),0.0);
        assertEquals(25.0,serviceDelivery.calculate("-(10-(7+7*4))"),0.0);
    ...
    public void serviceDeliveryInvalidExpressionTest() throws CalculatorException {
      serviceDelivery.calculate("10 - 9 * 9 - (2 + 8");
      serviceDelivery.calculate("7(");
      serviceDelivery.calculate("7()");
      serviceDelivery.calculate("4(6+");
      serviceDelivery.calculate("-((16+3)");
    }
}
